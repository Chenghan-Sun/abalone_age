...
pdf(file="MyFig.pdf", height = 10, width = 12)
ggpairs(data, aes(colour = sex, alpha = 0.6), title="Pairs plot for abalone dataset") + theme_grey(base_size = 8, fig.height=10, fig.width=12)
dev.off()
```
...
res_m2 <- resid(model2)
data$num_sex <- as.numeric(data$sex)
par(mfrow=c(8,3))
