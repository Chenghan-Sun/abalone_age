...
```{r}
pdf(file="../fig/diag_model_3_BIC_both.pdf", width=12)
layout(matrix(c(1,2),1,2))
...
```{r}
pdf(file="../fig/diag_model_3_BIC_for.pdf", width=12)
layout(matrix(c(1,2),1,2))
...
```{r}
pdf(file="../fig/diag_model_3_BIC_back.pdf", width=12)
layout(matrix(c(1,2),1,2))
...
max(abs(std_d_res))
sort(abs(std_d_res), decreasing=T)
...
sort(cook_distance[outlier_X], decreasing = TRUE)
sort(cook_distance[outlier_X], decreasing = TRUE) > 4/(n-p)
